...
node {
    ...
    def postbuild () {
        ...
        stage 'Publish HMTL Sonar'
		   publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: '.sonar', reportFiles: '${BUILD_TIMESTANP}-issues-report.html', reportName: 'SonarQube Report', reportTitles: ''])
